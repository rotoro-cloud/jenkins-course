...
layout: article
---
Перейдя по `Install a plugen` мы видим здесь разных вендоров: `AWS`, `Oracle`, `Azure`. Еще мы видим `Kubernetes` и `Docker`, которые не являются облачными провайдерами.
